...
% figure;
% imageType 1：Pavia University 9类样本
% imageType 2：Indian Pines、Houston 15、16类样本
% imageType 3：Salinas 16类样本
% imageType 4：Washington DC
% imageType 5：Pavia Center
% imageType 6：KSC 13类样本
